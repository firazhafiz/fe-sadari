    ...
    <div className="flex flex-col overflow-hidden">
      <ContainerScroll
        ...
        <div className="relative">
          ...
          <Link href="#tes" className="absolute z-10 inline-flex items-center justify-center rounded-full bg-[#FD567E] px-6 py-3 text-white shadow-lg hover:opacity-90 transition-opacity" style={overlayPosition}>
            Tes Sekarang
          </Link>
        </div>
      </ContainerScroll>
