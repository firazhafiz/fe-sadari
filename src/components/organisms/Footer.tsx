      ...
      <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-3 gap-8">
        ...
        <div>
          <Link href="/">
            <p className="flex items-center gap-2 mb-4">
              <Image src={"/assets/logo-sadari.png"} width={32} height={32} className="h-8 w-auto" alt="SADARI 4LIFE Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-navy">SADARI 4LIFE</span>
            </p>
          </Link>
          ...
          <ExportButton onclick={onclick} classname=" hover:bg-navy px-5 py-2 text-sm mt-8 border-2 text-navy border-navy  rounded-md font-medium hover:text-white cursor-pointer" />
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-4">
            <Image src={"/assets/instagram.png"} width={28} height={30} className="h-auto" alt="SADARI 4LIFE Logo" />
            <p className="text-gray-600 text-sm">sadari4life </p>
          </div>
          <div className="flex items-center gap-2 ">
            <Image src={"/assets/email.png"} width={28} height={32} className="h-auto" alt="SADARI 4LIFE Logo" />
