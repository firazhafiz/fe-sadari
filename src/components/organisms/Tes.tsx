...
export default function Tes() {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-10 flex justify-center gap-10 items-start">
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="mt-6">
          <button className="px-6 py-3 rounded-sm bg-navy text-white text-sm md:text-base font-semibold hover:bg-[#053b59] transition-colors">
            Mulai Tes
          </button>
        </div>
      </div>
