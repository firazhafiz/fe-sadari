...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-white p-3 [--cell-size:--spacing(8)] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border border-gray-300 shadow-xs has-focus:border-blue-500 has-focus:ring-blue-500/50 has-focus:ring-[3px] rounded-md",
        ...
        today: cn(
          "bg-blue-100 text-black rounded-md data-[selected=true]:rounded-none",
